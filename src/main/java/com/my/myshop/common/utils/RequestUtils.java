package com.my.myshop.common.utils;
    ...
    public static Map<String, Object> getJoinPointInfoMap(JoinPoint joinPoint) {
        ...
        for (int i = 0; i < length; i ++) {
            ...
            if (paramsArgsName.equalsIgnoreCase("request") ||
                    ...
                    paramsArgsName.equalsIgnoreCase("bindingResult")) {
                break;
            }
        ...
        Gson gson = new Gson();
//        String a = gson.toJson(paramMap);
        String a  = JSON.toJSONString(paramMap, SerializerFeature.IgnoreNonFieldGetter);
        joinPointInfo.put("paramMap", a);
        return joinPointInfo;
    }
}
